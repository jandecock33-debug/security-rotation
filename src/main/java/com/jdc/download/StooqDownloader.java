...
//    dl.downloadDailyCsv("ief.us", Path.of("data/IEF_stooq.csv"));
     ...
     * SP-500 Sectors
     */
//    dl.downloadDailyCsv("xlk.us", Path.of("data/XLK_stooq.csv"));
//    dl.downloadDailyCsv("xlf.us", Path.of("data/XLF_stooq.csv"));
//    dl.downloadDailyCsv("xlv.us", Path.of("data/XLV_stooq.csv"));
//    dl.downloadDailyCsv("xle.us", Path.of("data/XLE_stooq.csv"));
//    dl.downloadDailyCsv("xli.us", Path.of("data/XLI_stooq.csv"));
//    dl.downloadDailyCsv("xlp.us", Path.of("data/XLP_stooq.csv"));
//    dl.downloadDailyCsv("xly.us", Path.of("data/XLY_stooq.csv"));
//    dl.downloadDailyCsv("xlb.us", Path.of("data/XLB_stooq.csv"));
//    dl.downloadDailyCsv("xlu.us", Path.of("data/XLU_stooq.csv"));
//    dl.downloadDailyCsv("xlre.us", Path.of("data/XLRE_stooq.csv"));
//    dl.downloadDailyCsv("xlc.us", Path.of("data/XLC_stooq.csv"));

    /*
     * Vanguard sectors / industry ETFs
     */

//    dl.downloadDailyCsv("vgt.us", Path.of("data/VGT_stooq.csv"));
//    dl.downloadDailyCsv("vfh.us", Path.of("data/VFH_stooq.csv"));
//    dl.downloadDailyCsv("vht.us", Path.of("data/VHT_stooq.csv"));
//    dl.downloadDailyCsv("vde.us", Path.of("data/VDE_stooq.csv"));
//    dl.downloadDailyCsv("vis.us", Path.of("data/VIS_stooq.csv"));
//    dl.downloadDailyCsv("vdc.us", Path.of("data/VDC_stooq.csv"));
//    dl.downloadDailyCsv("vcr.us", Path.of("data/VCR_stooq.csv"));
//    dl.downloadDailyCsv("vaw.us", Path.of("data/VAW_stooq.csv"));
//    dl.downloadDailyCsv("vpu.us", Path.of("data/VPU_stooq.csv"));
//    dl.downloadDailyCsv("vnq.us", Path.of("data/VNQ_stooq.csv"));
//    dl.downloadDailyCsv("vox.us", Path.of("data/VOX_stooq.csv"));
